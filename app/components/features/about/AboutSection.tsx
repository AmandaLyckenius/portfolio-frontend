...
export default function AboutSection() {
    return <section id="about" className="px-4 py-24">
        ...
        <div className="max-w-4xl mx-auto">
            ...
            <div className="mt-12 bg-brand-surface rounded-3xl p-8 grid grid-cols-1 md:grid-cols-2 items-center justify-center gap-8 max-w-4xl w-full shadow-[0_8px_24px_rgba(15,23,42,0.10)] ">
